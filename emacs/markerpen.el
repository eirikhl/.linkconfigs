...
(defconst markerpen-initial-pen-attrs '((face . markerpen-face-a) ; markerpen"prev+1"
					(face . markerpen-face-b) ; markerpen
					(face . markerpen-face-c) ; markerpen
					(face . markerpen-face-d) ; markerpen
					(face . markerpen-face-e) ; markerpen
					(face . markerpen-face-f) ; markerpen
					))
